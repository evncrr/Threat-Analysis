...
LOAD DATA INFILE 'C:/ProgramData/MySQL/MySQL Server 8.3/Uploads/network_traffic.csv'
INTO TABLE network_traffic
...
LOAD DATA INFILE 'C:/ProgramData/MySQL/MySQL Server 8.3/Uploads/phishing.csv'
INTO TABLE phishing_urls
FIELDS TERMINATED BY ','
       ENCLOSED BY '"'
LINES  TERMINATED BY '\r\n'
IGNORE 1 ROWS
...
SELECT 'network_traffic' AS table_name, COUNT(*) AS rows_loaded FROM network_traffic
UNION ALL
